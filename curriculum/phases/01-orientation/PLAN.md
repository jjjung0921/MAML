...
- [x] U3. 원문 접근 및 evidence 카드 확보 — setup · est 10m · requires U1 · Done when: MAML/ANIL 원문 접근 확인, Phase 02 개념별 절·식 포인터가 있는 evidence 카드 생성 및 concept 포인터 연결; ANIL 발췌 위치 선정 (commit PENDING)
...
- [x] AC4. U3에서 원문 접근·Phase 02 evidence 포인터·Phase 03 독해 발췌 위치 확인.
